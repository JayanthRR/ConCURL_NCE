...
class NCEFunction(Function):
    ...
    def forward(self, x, y, memory, idx, params):
        ...
        # inner product
        #print(x.shape)
        out = torch.bmm(weight, x.unsqueeze(2))
    ...
    def backward(self, gradOutput):
        ...
        #print(batchSize, K, gradOutput.shape)
        gradOutput.unsqueeze(1)
        
        # gradient of linear
        #print('line 64', gradOutput.shape, weight.shape)
        #gradInput = torch.bmm(gradOutput.data, weight)
        gradInput = torch.bmm(gradOutput.unsqueeze(1), weight)
        #print(gradInput.shape, x.shape)
